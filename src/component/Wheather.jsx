        ...
        <div className="flex justify-center gap-2 flex-col">
            <div className=" flex flex-col">
                ...
                <input ref={inputref} className='border border-black   '
                    ...
                    } className='bg-green-500 w-28 m-auto mt-1'>Search</button>
            </div>
            <div
                ...
                <h2 className="text-md mb-2 px-4 pt-4">
                    <div className="flex justify-between">
                        <div className="badge relative top-0">
                            <span className="mt-2 py-1 h-12px text-md font-semibold w-12px  rounded right-1 bottom-1 px-4">{wheatherData.location}</span></div>
